...
from transformers.models.qwen3.modeling_qwen3 import (Optional, Union, torch, nn, ACT2FN, Cache, GenerationMixin, use_kernel_forward_from_hub, BaseModelOutputWithPast, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, PreTrainedModel, Unpack, can_return_tuple, Qwen3Config, __name__, Qwen3PreTrainedModel, Qwen3Model, KwargsForCausalLM, Qwen3ForCausalLM)
